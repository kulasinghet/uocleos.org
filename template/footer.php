...
<div id="newsletters" class="section third-section">
    ...
    <div class="container newsletter">
        ...
        <div class="row-fluid">
            ...
            <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol05-Issue01.pdf">
            ...
            <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol04-Issue10.pdf">
                        ...
                        <p>Our_Esssence Vol04 Issue10</p>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol04-Issue03.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol4-issue03.jpg" alt="vol 4 - issue 03">
                        <p>Our_Esssence Vol04 Issue03</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol04-Issue02.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol4-issue02.jpg" alt="vol 4 - issue 02">
                        <p>Our_Esssence Vol04 Issue02</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol04-Issue01.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol4-issue01.jpg" alt="vol 4 - issue 01">
                        <p>Our_Esssence Vol04 Issue01</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue11.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue11.jpg" alt="vol 3 - issue 11">
                        <p>Our_Esssence Vol03 Issue11</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue10.pdf">
                        ...
                        <p>Our_Esssence Vol03 Issue10</p>
                    </a>
                </li>
                <li>
                ...
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue07.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue07.jpg" alt="vol 3 - issue 07">
                        <p>Our_Esssence Vol03 Issue07</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue06.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue06.jpg" alt="vol 3 - issue 06">
                        <p>Our_Esssence Vol03 Issue06</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue05.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue05.jpg" alt="vol 3 - issue 05">
                        <p>Our_Esssence Vol03 Issue05</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue04.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue04.jpg" alt="vol 3 - issue 04">
                        <p>Our_Esssence Vol03 Issue04</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue03.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue03.jpg" alt="vol 3 - issue 03">
                        <p>Our_Esssence Vol03 Issue03</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue02.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue02.jpg" alt="vol 3 - issue 02">
                        <p>Our_Esssence Vol03 Issue02</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol03-Issue01.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol3-issue01.jpg" alt="vol 3 - issue 01">
                        <p>Our_Esssence Vol03 Issue01</p>
                    </a>
                </li>
                <!-- <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue10.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue10.jpg" alt="vol 2 - issue 10">
                        <p>Our_Esssence Vol02 Issue10</p>
                    </a>
                </li>
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue09.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue9.jpeg" alt="vol 2 - issue 9">
                        <p>Our_Esssence Vol02 Issue09</p>
                    </a>
                </li>

                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue08.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue8.webp" alt="vol 2 - issue 8">
                        <p>Our_Esssence Vol02 Issue08</p>
                    </a>
                </li>

                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue07.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue7.webp" alt="vol 2 - issue 7">
                ...
                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue03.pdf">
                        ...
                        <p>Our_Esssence Vol02 Issue03</p>
                    </a>
                </li>

                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue02.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue2.webp" alt="vol 2 - issue 2">
                        <p>Our_Esssence Vol02 Issue02</p>
                    </a>
                </li>

                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol02-Issue01.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol2-issue1.webp" alt="vol 2 - issue 1">
                        <p>Our_Esssence Vol02 Issue01</p>
                    </a>
                </li>

                <li>
                    <a href="<?php echo base_url() ?>/assets/contents/newsletters/Our_Esssence_Vol01-Issue08.pdf">
                        <img src="<?php echo base_url() ?>/assets/frontend/images/newsletters/vol1-issue8.webp" alt="vol 1 - issue 8">
                        <p>Our_Esssence Vol01 Issue08</p>
                    </a>
                </li> -->
        ...
        <div class="sub-section">
            ...
            <div class="row-fluid">
                ...
                <div class="span5">
                    ...
                    <p>Subscribe with your email address and keep in touch with club's updates, news and projects</p>
                ...
                <div class="span7">
                    ...
                    <div id="subscribes" class="button button-sp">Subscribe</div>



                    <div id="success-subscribe" class="success centered"></div>
...
<div class="footer">
    ...
    <p>uocleos.com &copy; 2019 . All Rights Reserved </p>
...
<script type="text/javascript" src="<?php echo base_url() ?>assets/frontend/js/jquery.bxslider.js"></script>
...
<script>
    $("#subscribes").click(function() {
        ...
        $.ajax({
            ...
            url: '<?php echo base_url(); ?>index.php/member/member_ajax',
            ...
            success: function(data) {
                ...
                setTimeout(function() {
                    ...
                    $("#success-subscribe").text("Successfully Subscribed");

                }, 2000);

            },

            complete: function(e, jqXHR, settings) {
...
<script>
    function showProject(projectId, projectHeading, leader, projectDate, projectContent) {
        ...
        document.getElementById('projectImage').src = dest;
        document.getElementById('projectHeading').innerHTML = projectHeading;
        document.getElementById('leader').innerHTML = leader;
        document.getElementById('projectDate').innerHTML = projectDate;
        document.getElementById('content').innerHTML = projectContent;*/
